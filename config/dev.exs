...
config :mimimi, MimimiWeb.Endpoint,
  ...
  code_reloader: true,
  debug_errors: true,
  secret_key_base: "EJMO/KNty94P3d7LkYJoqxltTYJ3PBazdhLeedLN60fWFBRLHWiZARENXLUpfWuO",
  watchers: [
    esbuild: {Esbuild, :install_and_run, [:mimimi, ~w(--sourcemap=inline --watch)]},
    tailwind: {Tailwind, :install_and_run, [:mimimi, ~w(--watch)]}
  ]
...
config :mimimi, MimimiWeb.Endpoint,
  live_reload: [
    ...
    patterns: [
      ...
      ~r"priv/gettext/.*(po)$",
      ~r"lib/mimimi_web/(?:controllers|live|components|router)/?.*\.(ex|heex)$"
    ]
  ]
